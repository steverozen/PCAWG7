...
tcga.uuid.file <- "data-raw/pcawg.sample.sheets/pc_annotation-tcga_uuid2barcode.tsv.gz"
...
pcawg.uuid.file <- "data-raw/pcawg.sample.sheets/pcawg_sample_sheet.v1.4.2016-09-14.tsv"
